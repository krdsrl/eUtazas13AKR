...
export default class FelszállásBérlet extends Felszállás {
    ...
    public get lejárHáromNap(): boolean {
        return this.érvényesFelszállás && Felszállás.napokSzáma(this._idő.getFullYear(), this._idő.getMonth() + 1, this._idő.getDay(), this._érvényes.getFullYear(), this._érvényes.getMonth() + 1, this._érvényes.getDay()) <= 3;
    }
